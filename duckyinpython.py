...
if (board.board_id == 'adafruit_qt2040_trinkey') or (board.board_id == 'waveshare_rp2040_zero'):
...
elif(board.board_id == 'adafruit_qt2040_trinkey') or (board.board_id == 'waveshare_rp2040_zero'):
...
def parseLine(line, script_lines):
    global DEFAULT_DELAY, variables, functions
    line = line.strip()
    if(line[0:3] == "REM"):
...
if (board.board_id == 'adafruit_qt2040_trinkey'):
    ...
    re_run_pin = digitalio.DigitalInOut(board.GP5)
    re_run_pin.switch_to_input(pull=digitalio.Pull.UP)
else:
...
if (board.board_id == 'adafruit_qt2040_trinkey'):
    ...
    payload1Pin = digitalio.DigitalInOut(board.GP10)
    payload1Pin.switch_to_input(pull=digitalio.Pull.UP)
    payloads.append(("payload1.dd", payload1Pin))

    payload2Pin = digitalio.DigitalInOut(board.GP11)
    payload2Pin.switch_to_input(pull=digitalio.Pull.UP)
    payloads.append(("payload2.dd", payload2Pin))

    payload3Pin = digitalio.DigitalInOut(board.GP12)
    payload3Pin.switch_to_input(pull=digitalio.Pull.UP)
    payloads.append(("payload3.dd", payload3Pin))

    payload4Pin = digitalio.DigitalInOut(board.GP13)
...
async def monitor_buttons(re_run_button):
